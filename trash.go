...
func run(c *cli.Context) error {
	...
	if update {
		return updateTrash(trashDir, dir, confFile, trashConf, insecure)
	}
	if err := vendor(keep, trashDir, dir, trashConf, insecure); err != nil {
		return err
	}
	if keep {
		return nil
...
func updateTrash(trashDir, dir, trashFile string, trashConf *conf.Conf, insecure bool) error {
...
func vendor(keep bool, trashDir, dir string, trashConf *conf.Conf, insecure bool) error {
